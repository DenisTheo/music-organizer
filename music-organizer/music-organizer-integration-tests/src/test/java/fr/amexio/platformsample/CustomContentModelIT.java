...
/**
 * Integration Test sample for a custom content model. See
 * {@link DemoComponentIT} for more info.
 *
...
public class CustomContentModelIT extends AbstractAlfrescoIT
{
	...
	private NodeRef createNode(String name, QName type, Map<QName, Serializable> properties)
	{
		...
		ChildAssociationRef parentChildAssocRef = getServiceRegistry().getNodeService().createNode(parentFolderNodeRef,
	...
	/**
	 * Get the node reference for the /Company Home top folder in Alfresco. Use the
	 * standard node locator service.
	 *
